...
| `GET`    | `/api/tales/:id`          | JWT  | Сказка: pages[], totalPages, мета         |
| `POST`   | `/api/tales/:id/narrate?page=0` | JWT | Озвучить одну страницу сказки → аудио   |
...
Текст разбит на **страницы** (`pages`) — каждая страница = один слайд/экран в приложении. Разбивка ручная, по смыслу.
...
```json
{
  ...
  "pages": [
    ...
    "Старуха наскребла муки, замесила тесто на сметане...",
